...
class GOModifyProductVC: GOBaseVC {
...
extension GOModifyProductVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{

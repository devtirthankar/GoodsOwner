...
extension GOMyProductVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        ...
        cell.column2Text.text = "\(prodNumber)"
        cell.column3Text.text = "Product \(prodNumber)"
        return cell
    }
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView{
        ...
        case UICollectionElementKindSectionHeader:
            ...
            headerView.configureMyProductsHeaderList()
            return headerView
